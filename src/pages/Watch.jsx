...
function Watch() {
  ...
  if (error) {
    return (
      <div className="mx-auto max-w-5xl rounded-xl border border-red-900 bg-red-950/20 p-5">
  ...
  return (
    <div className="mx-auto w-full max-w-6xl">
      ...
      {/* ================= VIDEO TITLE ================= */}
      <div className="mt-4">
        <h1 className="text-xl font-semibold leading-7 text-white sm:text-2xl">
          {video.title}
        </h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="h-11 w-11 overflow-hidden rounded-full bg-gray-800">
            {video.owner?.avatar?.url ? (
              ...
              <div className="flex h-full w-full items-center justify-center text-sm font-bold text-[#39FF14]">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="flex overflow-hidden rounded-full bg-gray-900">
            ...
            <button
              ...
              className="border-l border-gray-800 px-4 py-2 text-sm font-medium text-gray-300 transition hover:bg-gray-800 hover:text-[#39FF14] disabled:cursor-not-allowed disabled:opacity-40"
            >
              Save
            </button>
          </div>
      ...
      <section className="mt-8">
        ...
        >
          {/* Current User Avatar */}
          <div className="hidden h-10 w-10 shrink-0 overflow-hidden rounded-full bg-gray-800 sm:block">
            {user?.avatar ? (
              <img
                src={user.avatar}
                alt={user.username}
            ...
            <div className="flex gap-2">
              ...
              {editingComment && (
                <button
                  ...
                  className="rounded-full bg-gray-800 px-5 py-2 text-sm font-medium text-gray-300 transition hover:bg-gray-700"
                >
                  Cancel
                </button>
              )}
        ...
        {/* Error */}
        {commentsError && (
          <p className="mt-6 text-sm text-red-400">{commentsError}</p>
        )}
                  ...
                  {comment.owner?._id?.toString() === user?._id?.toString() && (
                    <>
                      <button
                        ...
                        className="text-xs text-gray-500 transition hover:text-[#39FF14]"
                      >
                        Edit
                      </button>
